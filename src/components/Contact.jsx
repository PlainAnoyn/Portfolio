        ...
        <div className="row g-5">
          ...
          >
            <div className="card card-custom border-0">
              <div className="card-body p-4">
                <h3 className="h3 fw-bold text-white mb-4">Send a Message</h3>
          ...
          >
            <div className="d-flex flex-column gap-4">
              <div className="card card-custom border-0">
                <div className="card-body p-4">
                  <h3 className="h3 fw-bold text-white mb-3">Let's Connect</h3>
              ...
              <div className="card card-custom border-0">
                <div className="card-body p-4">
                  <h4 className="h5 fw-semibold text-white mb-3">Follow Me</h4>
              ...
              <div className="card card-custom border-0">
                <div className="card-body p-4">
                  <h4 className="h5 fw-semibold text-white mb-3">Contact Details</h4>
